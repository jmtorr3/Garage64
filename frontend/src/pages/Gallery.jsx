...
const XP_BTN   = { fontSize: '11px', padding: '3px 10px', cursor: 'pointer', background: 'var(--bg-btn)', borderTop: '1px solid var(--bdr-btn-lt)', borderLeft: '1px solid var(--bdr-btn-lt)', borderRight: '1px solid var(--bdr-btn-dk)', borderBottom: '1px solid var(--bdr-btn-dk)', color: 'var(--clr-text)', fontFamily: 'Tahoma,sans-serif', fontWeight: 'bold' }
...
const s = {
  ...
  sideTitle:  { flex: 1, fontWeight: 'bold', color: 'var(--clr-text-on-title)', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.06em', fontFamily: 'Tahoma,sans-serif' },
  ...
  itemName:   { fontSize: '12px', fontWeight: 'bold', fontFamily: 'Tahoma,sans-serif' },
  itemSub:    { fontSize: '10px', color: 'var(--clr-text-dim)', fontFamily: 'Tahoma,sans-serif' },
  itemParts:  { display: 'flex', flexWrap: 'wrap', gap: '3px', marginTop: '3px' },
  badge:      { fontSize: '10px', background: 'var(--clr-badge-bg)', border: '1px solid var(--clr-badge-border)', color: 'var(--clr-badge-text)', padding: '1px 5px', fontFamily: 'Tahoma,sans-serif' },
  ...
  formTitle:  { fontWeight: 'bold', color: 'var(--clr-text)', fontSize: '12px', marginBottom: '2px', fontFamily: 'Tahoma,sans-serif' },
  label:      { display: 'block', fontSize: '11px', color: 'var(--clr-text-dim)', marginBottom: '2px', fontFamily: 'Tahoma,sans-serif' },
  input:      XP_INPUT,
  checkRow:   { display: 'flex', alignItems: 'center', gap: '7px', fontSize: '11px', padding: '2px 0', fontFamily: 'Tahoma,sans-serif' },
  ...
  error:      { color: 'var(--clr-err)', fontSize: '11px', fontFamily: 'Tahoma,sans-serif' },
  // viewer
  ...
  varName:    { fontWeight: 'bold', fontSize: '12px', fontFamily: 'Tahoma,sans-serif' },
  hint:       { color: 'var(--clr-text-dim)', fontSize: '10px', marginLeft: 'auto', fontFamily: 'Tahoma,sans-serif' },
  viewerWrap: { flex: 1, overflow: 'hidden' },
  empty:      { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--clr-text-dim)', fontSize: '12px', fontFamily: 'Tahoma,sans-serif' },
  errTxt:     { color: 'var(--clr-err)', fontSize: '11px', fontFamily: 'Tahoma,sans-serif' },
  loadTxt:    { color: 'var(--clr-text-dim)', fontSize: '11px', fontFamily: 'Tahoma,sans-serif' },
}
    ...
    <div style={s.page}>
      ...
      <div style={s.sidebar}>
        <div style={s.sideHead}>
          <span style={s.sideTitle}>Gallery</span>
          {editing === null
